          ...
          <div className="grid-2" style={{ gap: '3rem', alignItems: 'start' }}>
            ...
            <div style={{
              ...
              <p style={{ color: 'rgba(255,255,255,0.85)', lineHeight: 1.8 }}>
                Ser una iglesia que <strong style={{ color: '#c8a830' }}>glorifique a Dios</strong> en todo, que forme creyentes maduros en la fe, que alcance a los perdidos con el evangelio de gracia y que impacte positivamente a nuestra comunidad y nación con el amor de Cristo.
              </p>
              <p style={{ color: 'rgba(255,255,255,0.85)', lineHeight: 1.8, marginTop: '1rem', marginBottom: 0 }}>
        ...
        <div className="container">
          ...
          <div style={{ maxWidth: '700px', margin: '0 auto', position: 'relative' }}>
            <div style={{
              ...
              width: '2px', background: 'linear-gradient(to bottom, #c8a830, #1a2a4a)',
            }} />
            {timeline.map((item, i) => (
              <div key={i} style={{ display: 'flex', gap: '2rem', marginBottom: '2rem', position: 'relative' }}>
                <div style={{
                  ...
                  borderRadius: '50%',
                  background: i === timeline.length - 1 ? '#c8a830' : '#1a2a4a',
                  color: '#fff', display: 'flex', alignItems: 'center',
                  justifyContent: 'center', fontWeight: 700, fontSize: '0.75rem',
                  textAlign: 'center', zIndex: 1, border: '3px solid #fff',
                  boxShadow: '0 2px 8px rgba(0,0,0,0.15)',
                }}>
                  {item.year}
                </div>
                <div style={{
                  background: '#fff', borderRadius: '0.75rem', padding: '1.25rem 1.5rem',
                  boxShadow: '0 2px 8px rgba(0,0,0,0.08)', flex: 1, marginTop: '0.5rem',
                  borderLeft: `3px solid ${i === timeline.length - 1 ? '#c8a830' : '#1a2a4a'}`,
                }}>
                  <p style={{ marginBottom: 0, lineHeight: 1.7 }}>{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
