...
export default function Inicio() {
  return (
    <div>
      {/* Hero */}
      <section style={{
        background: 'linear-gradient(135deg, #0f1d35 0%, #1a2a4a 50%, #253d6b 100%)',
        color: '#fff',
        padding: '5rem 0',
        position: 'relative',
        overflow: 'hidden',
        ...
        <div style={{
          ...
          background: 'radial-gradient(ellipse at center, rgba(200,168,48,0.12) 0%, transparent 70%)',
        }} />
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ color: '#fff', marginBottom: '1rem', lineHeight: 1.15 }}>
            ¡Bienvenidos a<br />
            <span style={{ color: '#c8a830' }}>Iglesia La Biblia Dice</span>!
          </h1>
          <p style={{ fontSize: '1.35rem', color: 'rgba(255,255,255,0.85)', marginBottom: '0.5rem', fontStyle: 'italic' }}>
            "¡Más dulce que la miel!"
          </p>
          <p style={{ fontSize: '1.05rem', color: 'rgba(255,255,255,0.7)', maxWidth: '560px', margin: '0 auto 2.5rem' }}>
      ...
      {/* Quick Info Bar */}
      <section style={{ background: '#c8a830', padding: '2rem 0' }}>
          ...
          <div className="grid-4" style={{ gap: '1rem' }}>
            {quickLinks.map((item, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
                ...
                <div>
                  <div style={{ fontWeight: 700, color: '#0f1d35', fontSize: '0.875rem', marginBottom: '0.2rem' }}>{item.title}</div>
                  <div style={{ color: '#1a2a4a', fontSize: '0.85rem', lineHeight: 1.4 }}>{item.desc}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="container">
          <div className="grid-2" style={{ alignItems: 'center', gap: '4rem' }}>
            <div>
              ...
              <p style={{ lineHeight: 1.75, marginBottom: '1.75rem' }}>
            ...
            <div style={{
              ...
              <p style={{ color: '#c8a830', fontWeight: 600, marginBottom: 0 }}>— Proverbios 16:16</p>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  {[
                    ...
                    <div key={i} style={{ textAlign: 'center' }}>
                      <div style={{ fontSize: '1.8rem', fontWeight: 700, color: '#c8a830' }}>{s.num}</div>
            ...
            {upcomingEvents.map((event, i) => (
              <div key={i} style={{
                ...
                <div style={{ flexShrink: 0, textAlign: 'center', minWidth: '90px' }}>
                  <div style={{ background: '#1a2a4a', color: '#fff', borderRadius: '0.5rem', padding: '0.5rem 0.75rem' }}>
                    <div style={{ fontSize: '0.7rem', letterSpacing: '0.05em', marginBottom: '0.2rem' }}>📅</div>
                    <div style={{ fontSize: '0.75rem', fontWeight: 600 }}>{event.date}</div>
                  </div>
                  <div style={{ fontSize: '0.8rem', color: '#c8a830', fontWeight: 600, marginTop: '0.4rem' }}>{event.time}</div>
                </div>
                <div>
      ...
      <section className="section" style={{
        background: 'linear-gradient(135deg, #0f1d35 0%, #1a2a4a 100%)',
        textAlign: 'center',
      }}>
        <div className="container">
          <h2 style={{ color: '#fff', marginBottom: '1rem' }}>¿Listo para visitarnos?</h2>
          <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '1.1rem', maxWidth: '520px', margin: '0 auto 2rem' }}>
